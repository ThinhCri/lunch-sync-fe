...
export default function BottomNav() {
  ...
  const getTabClass = (path) => {
    const activeClass = "bg-primary/10 text-primary scale-98";
  ...
  return (
    <nav
      className="fixed bottom-0 w-full z-50 rounded-t-[2rem] bg-surface-container-lowest/90 backdrop-blur-2xl shadow-[0_-8px_24px_rgba(0,0,0,0.06)] flex justify-around items-center px-4 pt-3"

...
export default function Header({ title = "LunchSync", rightContent = null }) {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl shadow-[0_4px_16px_rgba(44,47,48,0.03)] border-b border-outline-variant/10 cursor-pointer select-none" onClick={() => navigate('/')}>
